		...
		<html>
			...
			<body>
				...
				<div class="headerWrap" id="headerWrap">
					<div id="header">
						<div id="logo"><a href="/"><img src="{$tpl}/img/9_bng.png" alt="Машук"/></a></div>
					...
					<div id="main">
						...
						<div id="infoWrapper">
							<div id="info">
								...
								<div id="content">
									<div id="nav_slider" style="position:absolute; top: 370px;width:579px; text-align:center; z-index:7;"></div>
